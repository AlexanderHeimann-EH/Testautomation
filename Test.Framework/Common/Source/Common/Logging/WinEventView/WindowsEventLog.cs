...
namespace EH.OpcDa.Common.Logging.WinEventView
{
    using System;
    ...
    public class WindowsEventLog
    {
        ...
        /// </summary>
        private static EHEventLogEntryType eventLogEntryType = EHEventLogEntryType.Error 
            | EHEventLogEntryType.FailureAudit
            | EHEventLogEntryType.Information
            | EHEventLogEntryType.SuccessAudit
            | EHEventLogEntryType.Warning
            | EHEventLogEntryType.Debug;
        ...
        {
            loggerConfigurationPath = System.IO.Path.Combine(loggerConfigurationFolder, LoggerConfigurationFile);
