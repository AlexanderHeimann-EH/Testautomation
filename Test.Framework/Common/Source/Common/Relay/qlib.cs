...
namespace EH.PCPS.TestAutomation.Common.Relay
{
  ...
  public class qlib32
  {
    ...
    public const uint JOB_WDOG3_SET_relays_TIME =     25;
    public const uint JOB_WDOG3_SET_REPEAT_TIME =     26;
    public const uint JOB_WDOG3_relays_INVERSION =    27;
    ...
    public const uint JOB_UNITIMER_relays1 =		29;
    public const uint JOB_UNITIMER_relays2 =		30;
    ...
    public const uint LASTCARD =			113;

    

    public const uint DEFAULTGPIB =			0x8000;
    
    [DllImport("qlib32.dll")]
    ...
    [DllImport("qlib32.dll", EntryPoint="QAPIExtSpecial")]
