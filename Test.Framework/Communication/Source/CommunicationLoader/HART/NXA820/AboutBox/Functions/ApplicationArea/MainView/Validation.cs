    ...
    public class Validation
    {
        ...
        static Validation()
        {
            try
            {
                ...
                NamespaceForHartComm = Configuration.CommunicationNamespace + ".AboutBox.Functions.ApplicationArea.MainView.Validation";
            }
        ...
        /// <summary>
        /// Gets the wait until module is ready.
        /// </summary>
        /// <value>The wait until module is ready.</value>
        public static IWaitUntilModuleIsReady WaitUntilModuleIsReady
        {
            get
            {
                var instance = LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForHartComm + ".WaitUntilModuleIsReady") as IWaitUntilModuleIsReady;
                if (instance == null)
                {
                    throw new Exception(LogInfo.Namespace(MethodBase.GetCurrentMethod()) + ". The interface implementation for the current method is invalid");
                }
