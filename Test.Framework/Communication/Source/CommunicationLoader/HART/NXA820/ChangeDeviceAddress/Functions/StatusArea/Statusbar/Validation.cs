...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.CommunicationLoader.HART.NXA820.ChangeDeviceAddress.Functions.StatusArea.Statusbar
{
    using System;
    ...
    using EH.PCPS.TestAutomation.CommunicationInterfaces.HART.NXA820.ChangeDeviceAddress.Functions.StatusArea.Statusbar.Validation;
    ...
    public class Validation
    {
        ...
        static Validation()
        {
            try
            {
                ...
                NamespaceForHartComm = Configuration.CommunicationNamespace + ".ChangeDeviceAddress.Functions.StatusArea.Statusbar.Validation";
            }
