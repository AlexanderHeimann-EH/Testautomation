...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.CommunicationLoader.HART.NXA820.Configuration.Functions.StatusArea.Statusbar
{
    using System;
    ...
    public class Validation
    {
        ...
        static Validation()
        {
            try
            {
                ...
                NamespaceForHartComm = Configuration.CommunicationNamespace + ".Configuration.Functions.StatusArea.Statusbar.Validation";
            }
