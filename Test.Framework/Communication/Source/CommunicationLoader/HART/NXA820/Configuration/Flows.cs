...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.CommunicationLoader.HART.NXA820.Configuration
{
    using System;
    ...
    public class Flows
    {
        ...
        static Flows()
        {
            try
            {
                ...
                NamespaceForCommunication = Configuration.CommunicationNamespace + ".Configuration.Flows";
            }
        ...
        public static IConfigure Configure
        {
            get
            {
                var instance = LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForCommunication + ".Configure") as IConfigure;
                if (instance == null)
                {
                    throw new Exception(LogInfo.Namespace(MethodBase.GetCurrentMethod()) + ". The interface implementation for the current method is invalid");
                }
