...
namespace EH.PCPS.TestAutomation.PROFIdtmDPV1.V220.Functions.ApplicationArea.Execution
{
    ...
    public class SetParameter
    {
        ...
        public bool SetParameterValue(Element element, Element elementOpen, string value)
        {
            ...
            return this.SetComboBoxValue(element, elementOpen, value);   
        }
        ...
        /// </summary>
        /// <param name="element">parameter to set</param>
        /// <param name="elementOpen">parameter button to open combo box</param>
        /// <param name="value">value to set</param>
        /// <returns>
        ///     <br>True: if parameter was set</br>
        ///     <br>Null: if an error occurred</br>
        ...
        private bool SetComboBoxValue(Element element, Element elementOpen, string value)
        {
            ...
            IList<ListItem> listItems = (new GUI.ProfIdtmDpv1RepoElements()).ComboBoxList;
