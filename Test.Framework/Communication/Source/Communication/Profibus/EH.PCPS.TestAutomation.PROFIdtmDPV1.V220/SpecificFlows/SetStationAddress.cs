// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SetStationAddress.cs" company="Endress+Hauser Process Solutions AG">
//   Copyright © Endress+Hauser Process Solutions AG 2015
// </copyright>
// <summary>
//   Provides a method to set the station address
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace EH.PCPS.TestAutomation.PROFIdtmDPV1.V220.SpecificFlows
{
    ...
    /// Provides a method to set the station address
    /// </summary>
    public class SetStationAddress
    {
        /// <summary>
        ...
        public bool Run(string value)
        {
            ...
            return setParam.SetParameterValue(new GUI.ProfIdtmDpv1RepoElements().StationAddress, value);
        }
    }
}
