...
namespace EH.PCPS.TestAutomation.RSG45HARTCommunication.V1011436.SpecificFlows
{
    ...
    {
        /// <summary>
        /// Sets the "End Address" combobox to a specific value
        /// </summary>
        ...
        public bool Run(string value)
        {
            ...
            return setParam.SetParameterValue(new GUI.RSG45HARTCommRepoElements().EndAddressCombobox, new GUI.RSG45HARTCommRepoElements().EndAddressComboButton, value);
        }
    }
}
