...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.Configuration.GUI.StatusArea.Statusbar
{
    ...
    public class StatusbarElements
    {
        ...
        /// </summary>
        private readonly global::EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.GUI.StatusArea.Statusbar.StatusbarElementsRepository repository;
        ...
        public StatusbarElements()
        {
            ...
            this.repository = global::EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.GUI.StatusArea.Statusbar.StatusbarElementsRepository.Instance;
        }
