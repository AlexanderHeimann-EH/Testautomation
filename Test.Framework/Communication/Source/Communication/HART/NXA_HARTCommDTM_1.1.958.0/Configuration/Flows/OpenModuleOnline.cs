...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.Configuration.Flows
{
    ...
    using EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.Configuration.Functions.ApplicationArea.MainView.Validation;
    ...
    public class OpenModuleOnline : IOpenModuleOnline
    {
        ...
        public bool Run()
        {
            ...
            {
                // Try to open module
                if (CommonFlows.OpenFunction.Run((new ModuleName()).Name)
                    == false)
                {
                ...
                else
                {
                    ...
                    if (
                        CommunicationLoader.HART.NXA820.Configuration.Functions.ApplicationArea.MainView.Validation
                    ...
                    else
                    {
                        ...
                        if (
                            CommunicationLoader.HART.NXA820.Configuration.Functions.StatusArea.Statusbar.Validation
                        ...
                        else
                        {
                            ...
                            if (
                                CommunicationLoader.HART.NXA820.Configuration.Functions.ApplicationArea.MainView
