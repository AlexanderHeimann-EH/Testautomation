...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.Configuration.Flows
{
    ...
    public class CloseModule : ICloseModule
    {
        ...
        public bool Run()
        {
            ...
            if (
                CommunicationLoader.HART.NXA820.Configuration.Functions.ApplicationArea.MainView.Validation.ModuleOpeningAndClosing.WaitUntilModuleIsClosed(numberOfOpenedModules, DefaultValues.iTimeoutModules) == false)
            {
