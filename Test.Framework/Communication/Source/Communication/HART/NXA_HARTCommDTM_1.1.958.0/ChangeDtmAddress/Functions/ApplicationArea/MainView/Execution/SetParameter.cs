...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDtmAddress.Functions.ApplicationArea.MainView.Execution
{
    ...
    using EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDtmAddress.GUI.ApplicationArea.MainView;
    ...
    public class SetParameter : ISetParameter
    {
        ...
        private bool SetComboBoxValue(Element element, string value)
        {
            ...
            IList<ListItem> listItems = (new ChangeDTMAddressMainViewElements()).ListItemsComboBox;
