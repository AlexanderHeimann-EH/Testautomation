...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.Flows
{
    ...
    public class CloseModule : ICloseModule
    {
        ...
        public bool Run()
        {
            ...
            if (
                CommunicationLoader.HART.NXA820.ChangeDeviceAddress.Functions.ApplicationArea.MainView.Validation.ModuleOpeningAndClosing.WaitUntilModuleIsClosed(numberOfOpenedModules, DefaultValues.iTimeoutModules) == false)
            {
