...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.Functions.ApplicationArea.MainView.Execution
{
    ...
    using EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.GUI.ApplicationArea.MainView;
    ...
    public class SetParameter : ISetParameter
    {
        ...
        private bool SetComboBoxValue(Element element, string value)
        {
            ...
            IList<ListItem> listItems = (new ChangeDeviceAddressMainViewElements()).ListItemsComboBox;
