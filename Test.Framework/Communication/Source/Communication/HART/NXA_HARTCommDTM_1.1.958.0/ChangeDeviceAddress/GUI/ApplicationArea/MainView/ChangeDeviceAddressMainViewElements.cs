//------------------------------------------------------------------------------
// <copyright file="ChangeDeviceAddressMainViewElements.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.NXA_HARTCommDTM.V119580.ChangeDeviceAddress.GUI.ApplicationArea.MainView
{
    ...
    /// </summary>
    public class ChangeDeviceAddressMainViewElements
    {
        #region members
        ...
        /// </summary>
        private readonly ChangeDeviceAddressMainViewRepository repository;
...
/// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeDeviceAddressMainViewElements"/> class.
        /// </summary>
        public ChangeDeviceAddressMainViewElements()
        {
            this.repository = ChangeDeviceAddressMainViewRepository.Instance;
            this.mdiClientPath =
