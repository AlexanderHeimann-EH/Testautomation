...
namespace EH.PCPS.TestAutomation.FFH1CommDTM.V1542.Functions.ApplicationArea.Execution
{
    ...
    public class SetParameter
    {
        ...
        private bool SetComboBoxValue(Element element, Element elementOpen, string value)
        {
            ...
            IList<ListItem> listItems = (new GUI.FFH1CommDTMRepoElements()).ComboboxList;
