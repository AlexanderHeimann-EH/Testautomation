...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.HostApplicationLoader.FDT.FieldCare.Functions.Dialogs.WriteToDeviceSuccessMessage
{
    using System;
    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.WriteToDeviceSuccessMessage.Execution";
            }
        ...
        /// <summary>
        /// Gets the write to device success.
        /// </summary>
        public static IWriteToDeviceSuccess WriteToDeviceSuccess
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".WriteToDeviceSuccess") as IWriteToDeviceSuccess;
            }
        }
