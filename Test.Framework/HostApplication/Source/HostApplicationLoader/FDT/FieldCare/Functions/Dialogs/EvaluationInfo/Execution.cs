...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.HostApplicationLoader.FDT.FieldCare.Functions.Dialogs.EvaluationInfo
{
    using System;
    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.EvaluationInfo.Execution";
            }
        ...
        /// <summary>
        /// Gets the evaluation info.
        /// </summary>
        public static IEvaluationInfo EvaluationInfo
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".EvaluationInfo") as IEvaluationInfo;
            }
        }
