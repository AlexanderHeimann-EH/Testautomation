    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.WritingToDevice.Execution";
            }
        ...
        /// <summary>
        /// Gets the writing to device.
        /// </summary>
        public static IWritingToDevice WritingToDevice
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".WritingToDevice") as IWritingToDevice;
            }
        }
