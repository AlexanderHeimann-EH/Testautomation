...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.HostApplicationLoader.FDT.FieldCare.Functions.Dialogs.WriteToDeviceInfoMessage
{
    using System;
    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.WriteToDeviceInfoMessage.Execution";
            }
        ...
        /// <summary>
        /// Gets the write to device info.
        /// </summary>
        public static IWriteToDeviceInfo WriteToDeviceInfo
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".WriteToDeviceInfo") as IWriteToDeviceInfo;
            }
        }
