    ...
    public class Validation
    {
        ...
        static Validation()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.ReportConfiguration.Validation";
            }
        ...
        /// <summary>
        /// Gets the is FDT print active.
        /// </summary>
        public static IIsFDTPrintActive IsFdtPrintActive
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".IsFDTPrintActive") as IIsFDTPrintActive;
            }
        }
