...
namespace EH.PCPS.TestAutomation.HostApplicationLoader.FDT.FieldCare.Functions.Dialogs.SaveProjectInProgress
{
    using System;
    ...
    public class Validation
    {
        ...
        static Validation()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.SaveProjectInProgress.Validation";
            }
        ...
        /// </summary>
        public static IValidationMethods ValidationMethods
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".ValidationMethods") as IValidationMethods;
            }
        }
