...
namespace EH.PCPS.TestAutomation.HostApplicationLoader.FDT.FieldCare.Functions.Dialogs.UpdateDTMCatalogue
{
    using System;
    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.Dialogs.UpdateDTMCatalogue.Execution";
            }
        ...
        /// <summary>
        /// Gets the update DTM catalogue.
        /// </summary>
        public static IUpdateDTMCatalogue UpdateDtmCatalogue
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".UpdateDtmCatalogue") as IUpdateDTMCatalogue;
            }
        }
