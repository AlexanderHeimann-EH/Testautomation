    ...
    public class Execution
    {
        ...
        static Execution()
        {
            try
            {
                ...
                NamespaceForFrames = Configuration.HostApplicationNamespace + ".Functions.ApplicationArea.MainView.Execution";
            }
        ...
        public static IGetCommDtmContainerPath GetCommDtmContainerPath
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".GetCommDtmContainerPath") as IGetCommDtmContainerPath;
            }
        }

        /// <summary>
        /// Gets the get STM container path.
        /// </summary>
        public static IGetDtmContainerPath GetDtmContainerPath
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".GetDtmContainerPath") as IGetDtmContainerPath;
            }
        }
        ...
        /// </summary>
        public static IStartFrame StartFrame
        {
            get
            {
                return LoaderHelper.CreateInstance(ExecutionDirectory, NamespaceForFrames + ".StartFrame") as IStartFrame;
            }
        }
