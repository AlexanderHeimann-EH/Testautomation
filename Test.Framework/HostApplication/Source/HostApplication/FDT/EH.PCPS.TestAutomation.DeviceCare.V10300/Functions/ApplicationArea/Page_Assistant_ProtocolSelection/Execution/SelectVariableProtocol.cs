...
namespace EH.PCPS.TestAutomation.DeviceCare.V10300.Functions.ApplicationArea.Page_Assistant_ProtocolSelection.Execution
{
    ...
    public class SelectVariableProtocol : ITestModule
    {
        ...
        public string Protocol { get; set; } = "Hart";
        ...
        void ITestModule.Run()
        {
            ...
            else
            {
                ...
                var protocolButton = repo.ApplicationArea.ProtocolSelection.ButtonProtocol_General;
                Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DeviceCare.ConnectionWizard.ProtocolButton' at Center."+ Protocol, repo.ApplicationArea.ProtocolSelection.ButtonProtocol_GeneralInfo, new RecordItemIndex(1));
                repo.ApplicationArea.ProtocolSelection.ButtonProtocol_General.Click();
            ...
            if (Protocol == "SI-IPC" || Protocol == "SI-ISS" || Protocol == "SI-PCP" || Protocol == "SI-CDI" )
            {
                ...
                var protocolButton = repo.ApplicationArea.ProtocolSelection.ButtonProtocol_General;
                Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DeviceCare.ConnectionWizard.ProtocolButton' at Center.", repo.ApplicationArea.ProtocolSelection.ButtonProtocol_GeneralInfo, new RecordItemIndex(1));
                repo.ApplicationArea.ProtocolSelection.ButtonProtocol_General.Click();
            }
        }
