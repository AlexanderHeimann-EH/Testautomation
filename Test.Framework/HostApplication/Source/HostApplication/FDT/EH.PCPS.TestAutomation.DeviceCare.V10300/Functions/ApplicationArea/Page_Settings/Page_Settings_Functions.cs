...
namespace EH.PCPS.TestAutomation.DeviceCare.V10300.Functions.ApplicationArea.Page_Settings
{
    ...
    public class Page_Settings_Functions
    {
        ...
        public void OpenSettingsPage()
        {
            ...
            repo.MenuArea.MainMenu.MainMenuItems.ButtonSettings.Click();
        }
        ...
        public bool TriggerUpdate()
        {
            ...
            var function = new EH.PCPS.TestAutomation.DeviceCare.V10300.CommonFlows.GetMessageLog();
        ...
        public void OpenDTMCatalog()
        {
            ...
            repo.MenuArea.MainMenu.SettingsMenuItems.ButtonDtmCatalog.Click();
        }
        /// <summary>
