		...
		void ITestModule.Run()
		{
            ...
            //Delay.Duration(10000, false); 
				...
				repo.modem_name = "automId" +Modem;
				 Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item automId" + Modem, repo.ApplicationArea.ProtocolSelection.ButtonProtocol_GeneralInfo, new RecordItemIndex(1));
