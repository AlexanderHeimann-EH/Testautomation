...
namespace EH.PCPS.TestAutomation.DeviceCare.V10300.Functions.ApplicationArea.Page_Assistant_ConfigureCommDTM
{
	/// <summary>
	...
	public class Assistant_ConfigureCommDTM_Functions
	{
		...
		public bool IsAdvancedConfigShown()
		{
			...
			var repo = GUI.DeviceCareApplication.Instance;
			var ocf = new EH.PCPS.TestAutomation.DeviceCare.V10300.Functions.Helpers.InterfaceHelpers.OnlineConnectFunctions();
