...
namespace EH.PCPS.TestAutomation.DeviceCare.V10300.Functions.Helpers
{
  ...
  public class Start_DeviceCare : ITestModule
  {
    ...
    EH.PCPS.TestAutomation.DeviceCare.V10300.GUI.DeviceCareApplication repo = EH.PCPS.TestAutomation.DeviceCare.V10300.GUI.DeviceCareApplication.Instance;
    ...
    public bool CheckStarted()
    {
       ...
       Host.Local.TryFindSingle(elementInfo.AbsolutePath, DefaultValues.iTimeoutLong, out button);
       
       bool exist = repo.MenuArea.MainMenu.MainMenuItems.ButtonHomeInfo.Exists();
       bool visible;
       if(button == null)
       {
       	visible = false;
