// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunFdtReadFromDevice.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V20901.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [FDT Upload]-functionality
    ///     FDT Upload is also known as [Read from device]
    /// </summary>
    public class RunFdtReadFromDevice : MarshalByRefObject, IRunFdtReadFromDevice
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryReadFromDevice;
