...
namespace EH.PCPS.TestAutomation.FieldCare.V20901.Functions.MenuArea.Menubar.Execution
{
    ...
    using EH.PCPS.TestAutomation.FieldCare.V20901.Functions.ApplicationArea.MainView.Validation;
        ...
        public bool ViaWindow(string moduleToClose, bool closeExpected)
        {
            ...
            try
            {
                ...
                if (formList != null && formList.Count > 0)
                {
                    ...
                    if (moduleName.Length == 0)
                    {
                        EH.PCPS.TestAutomation.Common.Tools.Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module is not available to close");
                        return false;
                    }
                ...
                EH.PCPS.TestAutomation.Common.Tools.Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module [" + moduleToClose + "] is not available and could not be closed.");
                return false;
            }
            catch (ActionFailedException actionFailedException)
            {
                if (closeExpected)
                {
                    ...
                    while (isOpen)
                    {
                            ...
                            if (formList != null && formList.Count > 0)
                            {
                                ...
                                foreach (Form form in formList)
                                {
                                    if (form != null)
                                    {
                                        ...
                                        {
                                            EH.PCPS.TestAutomation.Common.Tools.Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module closed.");
                                        }
                                    }
                                }
                            }
                        ...
                        {
                            EH.PCPS.TestAutomation.Common.Tools.Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), actionFailedException.Message);
                            EH.PCPS.TestAutomation.Common.Tools.Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module [" + moduleToClose + "] is not closed within " + timeOutInMilliseconds + " Milliseconds");
                            isOpen = false;
                        }
                    }
                ...
                {
                    EH.PCPS.TestAutomation.Common.Tools.Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module [" + moduleToClose + "] not closed, but isn't expected, may a close dialog appeared");
                }
