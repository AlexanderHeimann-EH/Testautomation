// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenOfflineParameterization.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V20901.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class OpenOfflineParameterization : MarshalByRefObject, IOpenOfflineParameterization
    {
        /// <summary>
        ...
        public string ViaMenu()
        {
            try
            {
                ...
                if (element != null && element.Enabled)
                {
                    ...
                    Button menuEntry = (new Elements()).EntryOfflineParameterize;
