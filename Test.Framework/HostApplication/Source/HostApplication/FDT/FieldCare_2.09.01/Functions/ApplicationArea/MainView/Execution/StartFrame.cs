...
namespace EH.PCPS.TestAutomation.FieldCare.V20901.Functions.ApplicationArea.MainView.Execution
{
    ...
    using EH.PCPS.TestAutomation.FieldCare.V20901.Functions.Dialogs.UpdateDtmCatalogMessageOnStartup.Execution;
    using EH.PCPS.TestAutomation.FieldCare.V20901.Functions.Dialogs.UpdateDtmCatalogMessageOnStartup.Validation;
    ...
    public class StartFrame : MarshalByRefObject, IStartFrame
    {
        ...
        /// </summary>
        /// <param name="strApplicationPath">The string application path.</param>
        /// <returns><c>true</c> if true is returned, <c>false</c> otherwise.</returns>
        ...
        /// </summary>
        /// <param name="strApplicationPath">FieldCare installation path</param>
        /// <param name="timeOutInMilliseconds">Time until Frame could be opened, before an error message appears</param>
        /// <returns>Returns process ID in case of success or -1 in case of failure</returns>
                ...
                while (isSearching)
                {
                    if (watch.ElapsedMilliseconds > timeOutInMilliseconds)
                    {
                        ...
                        Log.Error(
                            ...
                            "Frame was not ready after " + timeOutInMilliseconds + " Milliseconds");
                    }
                    else
                    {
        ...
        /// </summary>
        /// <param name="path">Path for application</param>
