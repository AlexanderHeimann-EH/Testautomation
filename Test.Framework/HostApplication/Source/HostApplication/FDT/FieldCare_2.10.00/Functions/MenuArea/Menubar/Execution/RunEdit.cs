//------------------------------------------------------------------------------
// <copyright file="RunEdit.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21000.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Description of RunEdit.
    /// </summary>
    public class RunEdit : MarshalByRefObject, IRunEdit
    {
        /// <summary>
        ...
        public Element ViaMenu()
        {
            try
            {
                MenuItem menuItem = (new Elements()).MenuEdit;
                if (menuItem != null && menuItem.Enabled)
                {
                    menuItem.Click(DefaultValues.locDefaultLocation);

                    // select container for Frame -> Edit menu entries
