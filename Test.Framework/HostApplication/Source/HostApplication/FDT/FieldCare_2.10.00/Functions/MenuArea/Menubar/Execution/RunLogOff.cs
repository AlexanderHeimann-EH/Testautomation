// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunLogOff.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21000.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Log Off]-functionality
    /// </summary>
    public class RunLogOff : MarshalByRefObject, IRunLogOff
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryLogOff;
