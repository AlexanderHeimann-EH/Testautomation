//------------------------------------------------------------------------------
// <copyright file="RunDtmCatalogue.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21000.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Description of RunDTMCatalogue.
    /// </summary>
    public class RunDtmCatalogue : MarshalByRefObject, IRunDtmCatalogue
    {
        /// <summary>
        ...
        public Element ViaMenu()
        {
            try
            {
                MenuItem menuItem = (new Elements()).MenuDtmCatalog;
                if (menuItem != null && menuItem.Enabled)
                {
                    menuItem.Click(DefaultValues.locDefaultLocation);

                    // select container for Frame -> DTM Catalogue menu entries
