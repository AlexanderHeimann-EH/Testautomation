// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunProjectClose.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21000.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Close Project]-functionality
    /// </summary>
    public class RunProjectClose : MarshalByRefObject, IRunProjectClose
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryClose;
