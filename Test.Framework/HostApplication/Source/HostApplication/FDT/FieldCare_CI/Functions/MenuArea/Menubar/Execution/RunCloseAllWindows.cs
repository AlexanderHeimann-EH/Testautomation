//------------------------------------------------------------------------------
// <copyright file="RunCloseAllWindows.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Close All Window]-functionality
    /// </summary>
    public class RunCloseAllWindows : MarshalByRefObject, IRunCloseAllWindows
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryCloseAll;
