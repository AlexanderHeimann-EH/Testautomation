// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenPrintSetup.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Print Setup]-functionality
    /// </summary>
    public class OpenPrintSetup : MarshalByRefObject, IOpenPrintSetup
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryPrintSetup;
