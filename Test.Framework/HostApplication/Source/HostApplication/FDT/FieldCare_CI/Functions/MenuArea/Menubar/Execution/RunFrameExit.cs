// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunFrameExit.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Exit Frame]-functionality
    /// </summary>
    public class RunFrameExit : MarshalByRefObject, IRunFrameExit
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryExit;
