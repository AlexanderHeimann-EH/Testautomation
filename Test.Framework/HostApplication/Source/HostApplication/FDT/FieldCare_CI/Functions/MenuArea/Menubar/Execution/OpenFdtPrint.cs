// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenFDTPrint.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [FDTPrint]-functionality
    /// </summary>
    public class OpenFdtPrint : MarshalByRefObject, IOpenFdtPrint
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryPrint;
