//------------------------------------------------------------------------------
// <copyright file="RunConnect.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.MenuArea.Toolbar.Execution
{
    ...
    using EH.PCPS.TestAutomation.FieldCare.CI.GUI.MenuArea.Toolbar;
    ...
    /// </summary>
    public class RunConnect : MarshalByRefObject, IRunConnect
    {
        /// <summary>
        ...
        public bool ViaIcon()
        {
            try
            {
                Button button = (new IconElements()).DisconnectedColored;
