...
namespace EH.PCPS.TestAutomation.FieldCare.CI.Functions.Dialogs.ReportConfiguration.Execution
{
    using System;
    ...
    public class ReportConfiguration : MarshalByRefObject, IReportConfiguration
    {
        ...
        public bool SelectReportType(string reportType)
        {
            try
            {
                ...
                if (comboBox != null && comboBox.Enabled)
                {
                    ...
                    Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "ListItem is not accessible.");
                    return false;
                }
        ...
        public bool Print(string reportType)
        {
            try
            {
                ...
                Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "An error occurred while selecting report type.");
                return false;
            }
            catch (Exception exception)
            {
