// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WriteToDeviceInfoMessagePaths.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21100.GUI.Dialogs
{
    ...
    /// </summary>
    public static class WriteToDeviceInfoMessagePaths
    {
        #region Declaration
        ...
        /// </summary>
        static WriteToDeviceInfoMessagePaths()
        {
