...
namespace EH.PCPS.TestAutomation.FieldCare.V21100.GUI.MenuArea.MenuBar
{
    using System;
        ...
        public Element MenuElement(IntPtr handle)
        {
            try
            {
                ...
                while (isSearching && retries < DefaultValues.SearchRetries)
                {
                    ...
                    {
                        EH.PCPS.TestAutomation.Common.Tools.Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "MenuElement found");
                        isSearching = false;
                    }
                    else
                    {
                ...
                if (element == null)
                {
                    EH.PCPS.TestAutomation.Common.Tools.Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "MenuElement not found");
                }
