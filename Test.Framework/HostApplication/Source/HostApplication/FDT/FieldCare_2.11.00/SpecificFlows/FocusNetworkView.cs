    ...
    public class FocusNetworkView : MarshalByRefObject, IFocusNetworkView
    {
        ...
        public bool Run()
        {
            ...
            if (element != null)
            {
                ...
                Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "[Network View] is in focus.");
                return true;
            }

            Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Could not focus [Network View]");
            return false;
        }
    }
}