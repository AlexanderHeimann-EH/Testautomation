// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenProjectSaveAs.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21100.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Project Save As]-functionality
    /// </summary>
    public class OpenProjectSaveAs : MarshalByRefObject, IOpenProjectSaveAs
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntrySaveAs;
