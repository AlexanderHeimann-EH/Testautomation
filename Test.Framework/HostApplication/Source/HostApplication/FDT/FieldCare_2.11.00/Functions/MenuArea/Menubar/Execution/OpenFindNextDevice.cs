// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenFindNextDevice.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21100.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Start [Find Next]-functionality
    /// </summary>
    public class OpenFindNextDevice : MarshalByRefObject, IOpenFindNextDevice
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button menuEntry = (new Elements()).EntryFindNext;
