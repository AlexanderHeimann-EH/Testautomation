//------------------------------------------------------------------------------
// <copyright file="RunExtras.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.FieldCare.V21100.Functions.MenuArea.Menubar.Execution
{
    ...
    /// <summary>
    ///     Description of RunExtras.
    /// </summary>
    public class RunExtras : MarshalByRefObject, IRunExtras
    {
        /// <summary>
        ...
        public Element ViaMenu()
        {
            try
            {
                MenuItem menuItem = (new Elements()).MenuExtras;
                if (menuItem != null && menuItem.Enabled)
                {
                    menuItem.Click(DefaultValues.locDefaultLocation);

                    // select container for Frame -> Extras menu entries
