...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke Action", "Invoking Focus() on item 'DeviceCare.MenuArea.AriadnePath.Modem'.", repo.DeviceCare.MenuArea.AriadnePath.ModemInfo, new RecordItemIndex(0));
            repo.DeviceCare.MenuArea.AriadnePath.Modem.Focus();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DeviceCare.MenuArea.AriadnePath.Modem' at Center.", repo.DeviceCare.MenuArea.AriadnePath.ModemInfo, new RecordItemIndex(1));
            repo.DeviceCare.MenuArea.AriadnePath.Modem.Click();
