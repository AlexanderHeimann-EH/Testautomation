...
namespace EH.PCPS.TestAutomation.DeviceCare.V10107.Functions.ApplicationArea.Page_Home
{
    using System;
    ...
    public class Page_Home_Functions
    {
        ...
        {
            this.repo.DeviceCare.MenuArea.MainMenu.ButtonHome.Click();
        }
        ...
        {
            return this.repo.DeviceCare.ApplicationArea.Page_Home.Self.Visible;
        }
        ...
        {
            this.repo.DeviceCare.MenuArea.MainMenu.ButtonExit.Click();
        }
        ...
        {
            this.repo.DeviceCare.ApplicationArea.Page_Home.ButtonConnectionWizard.Click();
        }
        ...
        private void ClickAutomatic()
        {
            ...
            this.repo.DeviceCare.ApplicationArea.Page_Home.ButtonConnectionAutomatic.Click();
        }
    }
}
