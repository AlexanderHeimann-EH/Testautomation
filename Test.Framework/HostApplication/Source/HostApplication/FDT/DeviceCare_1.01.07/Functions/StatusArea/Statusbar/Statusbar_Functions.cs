...
namespace EH.PCPS.TestAutomation.DeviceCare.V10107.Functions.StatusArea.Statusbar
{
    using System;
    ...
    public class Statusbar_Functions
    {
        ...
        public bool IsCommunicationUnitRecognized()
        {
            ...
            for (int i = 0; i <= repo.DeviceCare.StatusArea.UsbCommunicationUnitList.Children.Count - 1; i++)
            {
                string repoElementText = repo.DeviceCare.StatusArea.UsbCommunicationUnitListElement.Element.GetAttributeValueText("Name");
        ...
        {
            var repo = GUI.DeviceCareApplication.Instance;
            string helpText = repo.DeviceCare.StatusArea.ConnectionIndicator.Element.GetAttributeValueText("HelpText");

            if (helpText.Contains("Connected"))
            {
                return true;
            }
        ...
        {
            var repo = GUI.DeviceCareApplication.Instance;
            return repo.DeviceCare.StatusArea.EventMessage_Text.Element.GetAttributeValueText("Text");
        }
        ...
        public bool IsActionFinished()
        {
            ...
            bool isVisible = Convert.ToBoolean(repo.DeviceCare.StatusArea.ProgressIndicator.Element.GetAttributeValue("Visible"));
            ...
            while (isVisible)
            {
                isVisible = Convert.ToBoolean(repo.DeviceCare.StatusArea.ProgressIndicator.Element.GetAttributeValue("Visible"));
        ...
        public int GetUSBModemCount()
        {
            ...
            return repo.DeviceCare.StatusArea.UsbCommunicationUnitList.Children.Count;
        }
        ...
        public string GetCommUnitName()
        {
            var repo = GUI.DeviceCareApplication.Instance;
            repo.DeviceCare.StatusArea.UsbCommunicationUnitList.Click();
            Element element = repo.DeviceCare.StatusArea.UsbCommunicationUnitListElementText.Element;
        ...
        public bool WaitForScanning(string commDriverName)
        {
            ...
            while (isOnline == false)
            {
                ...
                string indicator = repo.DeviceCare.StatusArea.ConnectionIndicator.Element.GetAttributeValueText("HelpText");
        ...
        public void OpenEventLog()
        {
            ...
            {
                repo.DeviceCare.StatusArea.Self.DoubleClick(Location.Center);
            }
        }
