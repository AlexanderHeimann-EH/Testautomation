...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurveShed.GUI.ApplicationArea.MainView
{
    using Ranorex;
    using Ranorex.Core;
    ...
    public class ModuleContainerElements
    {
        ...
        public Element ModuleContainer
        {
            ...
            {
                Element element;
                RepoItemInfo itemInfo = this.repository.EnvelopeCurveModuleContainerInfo;
