...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurveShed.Functions.ApplicationArea.MainView.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurveShed.GUI.MenuArea.Toolbar;
    ...
    public class WaitUntilModuleOnlineIsReady : IWaitUntilModuleOnlineIsReady
    {
        ...
        public bool Run(int timeOutInMilliseconds)
        {
            ...
            while (new EnvelopeCurve.Functions.ApplicationArea.MainView.Validation.IsModuleReady().IsModuleOnlineReady((new Elements()).BtnReadCurve) == false)
            {
