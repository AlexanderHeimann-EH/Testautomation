//------------------------------------------------------------------------------
// <copyright file="RunMoveIdealEchoCurveToPeak.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunMoveIdealEchoCurveToPeak : IRunMoveIdealEchoCurveToPeak
    {
        /// <summary>
        ///     Start via related menu-entry
        /// </summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryMoveIdealEchoCurveToPeak;
