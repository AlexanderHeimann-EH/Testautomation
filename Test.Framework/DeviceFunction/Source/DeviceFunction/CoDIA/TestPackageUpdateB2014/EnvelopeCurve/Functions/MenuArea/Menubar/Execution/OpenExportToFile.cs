//------------------------------------------------------------------------------
// <copyright file="OpenExportToFile.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class OpenExportToFile : IOpenExportToFile
    {
        /// <summary>
        ///     Start via related menu-entry
        /// </summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryExportToFile;
