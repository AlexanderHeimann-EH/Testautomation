// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunTresholdBrokenProbe1.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunTresholdBrockenProbe1 : IRunTresholdBrokenProbe1
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                Element element = (new RunCursor1()).ViaMenu();
                if (element != null && element.Enabled)
                {
                    Button button = (new Elements()).EntryThresholdBrokenProbe;
