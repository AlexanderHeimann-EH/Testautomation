//------------------------------------------------------------------------------
// <copyright file="RunDiagramParametersPlausibility.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateB2014.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunDiagramParametersPlausibility : IRunDiagramParametersPlausibility
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryDiagramParametersPlausibility;
