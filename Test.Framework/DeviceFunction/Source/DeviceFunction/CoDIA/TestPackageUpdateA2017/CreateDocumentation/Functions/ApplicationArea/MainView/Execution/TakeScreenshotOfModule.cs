...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.CreateDocumentation.Functions.ApplicationArea.MainView.Execution
{
    ...
    public class TakeScreenshotOfModule : ITakeScreenshotOfModule
    {
        ...
        public void Run()
        {
            Ranorex.Core.Element moduleContainer = new Compare.GUI.ApplicationArea.MainView.ModuleContainerElements().ModuleContainer;
            ...
            {
                Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Taking screenshot of the module CreateDocumentation");
