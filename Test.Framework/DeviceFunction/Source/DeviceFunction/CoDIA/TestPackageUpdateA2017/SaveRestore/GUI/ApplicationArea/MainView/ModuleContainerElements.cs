...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.SaveRestore.GUI.ApplicationArea.MainView
{
    using Ranorex;
    using Ranorex.Core;
    ...
    public class ModuleContainerElements
    {
        ...
        public Element ModuleContainer
        {
            ...
            {
                Element element;
                RepoItemInfo itemInfo = this.repository.SaveRestoreModuleContainerInfo;
