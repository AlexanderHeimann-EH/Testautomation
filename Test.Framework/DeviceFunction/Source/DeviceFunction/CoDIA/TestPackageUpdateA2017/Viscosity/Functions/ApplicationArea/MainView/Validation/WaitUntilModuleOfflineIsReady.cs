...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.Viscosity.Functions.ApplicationArea.MainView.Validation
{
    ...
    /// </summary>
    public class WaitUntilModuleOfflineIsReady : MarshalByRefObject, IWaitUntilModuleOfflineIsReady
    {
        /// <summary>
        ...
        public bool Run(int timeOutInMilliseconds)
        {
            ...
            while (new IsModuleReady().IsModuleOfflineReady((new ToolbarElements()).ImportButton) ==
                    false)
            {
