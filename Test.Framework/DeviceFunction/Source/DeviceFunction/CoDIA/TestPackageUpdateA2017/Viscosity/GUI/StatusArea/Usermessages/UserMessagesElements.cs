...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.Viscosity.GUI.StatusArea.Usermessages
{
    using System;
        ...
        public string UserNotificationMessage
        {
            get
            {
                try
                {
                    ...
                    if (element == null)
                    {
                        Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Viscosity Module Message Control Popup is not found ");
                        return string.Empty;  
                    }
