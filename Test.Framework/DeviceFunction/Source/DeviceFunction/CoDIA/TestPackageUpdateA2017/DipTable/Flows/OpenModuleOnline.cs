...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.DipTable.Flows
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2017.DipTable.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.DipTable.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
