...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.Concentration.Functions.MenuArea.Toolbar.Execution
{
    using System;
    ...
    public class OpenImport : MarshalByRefObject, IOpenImport
    {
        ...
        public bool ViaIcon()
        {
            try
            {
                Button button = (new ToolbarElements()).ButtonImport;
