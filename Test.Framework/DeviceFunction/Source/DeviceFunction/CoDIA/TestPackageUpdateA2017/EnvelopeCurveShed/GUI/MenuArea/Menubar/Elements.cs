...
//------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.EnvelopeCurveShed.GUI.MenuArea.Menubar
{
    using System;
            ...
            get
            {
                try
                {
                    ...
                    RepoItemInfo layoutDiagramParametersPlausibilityInfo =
                        this.repository.buttonLayoutDiagramPlusParametersPlusPlausibilityInfo;
                    Host.Local.TryFindSingle(
