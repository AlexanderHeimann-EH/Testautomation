//------------------------------------------------------------------------------
// <copyright file="RunParameters.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2017.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunParameters : IRunParameters
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryParameters;
