...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Concentration.Flows
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.Concentration.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.Concentration.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
