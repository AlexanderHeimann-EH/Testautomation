...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Linearization.Flows
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.Linearization.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.Linearization.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
