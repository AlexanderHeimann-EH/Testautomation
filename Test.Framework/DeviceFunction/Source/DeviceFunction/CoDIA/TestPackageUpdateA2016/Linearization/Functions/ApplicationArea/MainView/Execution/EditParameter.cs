...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Linearization.Functions.ApplicationArea.MainView.Execution
{
    ...
    /// </summary>
    public class EditParameter : IEditParameter
    {
        #region public
        ...
        public bool SetParameterValue(Element element, string value)
        {
            ...
            switch (controlType)
            {
                ...
                case "EH.CoDIA.Linearization.GUI.TankEditor.PresentationLayer.Controls.SimpleTankParamControl":
                    {
                        return this.SetTextValue(element, value);
                    }

                case "EH.PCSW.PresentationLayer.WinFormBase.Controls.Generic.ValidationControlGeneric":
                    {
                        return this.SetTextValue(element, value);
                    }
                ...
                case "EH.CoDIA.Linearization.GUI.TankEditor.PresentationLayer.Controls.ComboBoxControlEx":
                    {
                        return this.SetComboBoxValue(element, value);
                    }

                case "EH.PCSW.PresentationLayer.WinFormBase.Controls.Generic.ComboBoxControlGeneric":
                    {
                        return this.SetComboBoxValue(element, value);
                    }
                ...
                case "EH.PCSW.PresentationLayer.WinFormBase.Controls.IntegerTextBox":
                    {
                        return this.SetTextValue(element, value);
                    }
        ...
        private bool SetComboBoxValue(Element element, string value)
        {
            ...
            IList<ListItem> listItems = (new MainViewElements()).ListItemsComboBox;
        ...
        private bool FindAndSelectValueInComboBox(IList<ListItem> listItems, string value)
        {
            ...
            {
                string actualItem = pattern.Replace(item.Text, string.Empty);
                string itemToSet = pattern.Replace(value, string.Empty);
