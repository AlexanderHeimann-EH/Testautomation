...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Linearization.Functions.StatusArea.Statusbar.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.Linearization.GUI.StatusArea.Statusbar;
    ...
    public class ReadingAndWriting : IReadingAndWriting
    {
        ...
        public bool HasReadingStarted(int timeoutInMilliseconds)
        {
            ...
            // Progressbar did not appear -> timeout
            if (button == null)
            {
