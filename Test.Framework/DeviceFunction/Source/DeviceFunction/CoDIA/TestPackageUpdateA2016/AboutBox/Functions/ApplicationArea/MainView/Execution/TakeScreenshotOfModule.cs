...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.AboutBox.Functions.ApplicationArea.MainView.Execution
{
    ...
    public class TakeScreenshotOfModule : ITakeScreenshotOfModule
    {
        ...
        public void Run()
        {
            ...
            {
                Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Taking screenshot of the module AboutBox");
