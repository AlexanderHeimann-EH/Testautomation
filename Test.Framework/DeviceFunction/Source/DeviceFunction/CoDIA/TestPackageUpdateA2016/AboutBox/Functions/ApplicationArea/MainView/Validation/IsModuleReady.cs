...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.AboutBox.Functions.ApplicationArea.MainView.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.AboutBox.GUI.ApplicationArea.MainView;
