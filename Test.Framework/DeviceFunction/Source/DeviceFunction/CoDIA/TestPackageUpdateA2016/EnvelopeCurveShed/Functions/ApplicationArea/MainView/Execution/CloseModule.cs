...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.EnvelopeCurveShed.Functions.ApplicationArea.MainView.Execution
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.EnvelopeCurve.Functions.ApplicationArea.MainView.Validation;
    ...
    public class CloseModule : ICloseModule
    {
        ...
        /// Module name, if it differs from intended name
        /// </param>
        /// <param name="closeExpected">
        /// Boolean, if close expected or not
        /// </param>
        /// <returns>
        /// <br>True: if everything worked fine</br>
        ///     <br>False: if an error occurred</br>
