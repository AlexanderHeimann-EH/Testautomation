...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.EnvelopeCurveShed.Functions.ApplicationArea.MainView.Validation
{
    ...
    public class ModuleOpeningAndClosing : IModuleOpeningAndClosing
    {
        ...
        public bool WaitUntilModuleIsClosed(int timeOutInMilliseconds)
        {
            ...
            {
                Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module is not closed after " + timeOutInMilliseconds + "Milliseconds.");
            }
        ...
        public bool WaitUntilModuleIsOpen(int timeOutInMilliseconds)
        {
            ...
            {
                Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module is not opened after " + timeOutInMilliseconds + "Milliseconds.");
            }
