...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Parameterization.GUI.ApplicationArea.MainView
{
    ...
    public static class NavigationPaths
    {
        ...
        static NavigationPaths()
        {
            ...
            StrNaviAreaHoricontalScrollBar = @GUIHelpString
                                             + "/container[@controltypename='DtmUserInterface']/container[@controlname='DtmNavigationArea']/element/container/element/element[@controltypename='HTLScrollBar']/scrollbar";
            ...
            StrNaviAreaHScrollBarColumnRight = StrNaviAreaHoricontalScrollBar
                                               + "/button[@accessiblename='Column Right']";
            ...
            // Paths for 
            StrModuleDTMOnlineProtector = @GUIHelpString
                                          + "/container[@controltypename='DtmUserInterface']/picture[@controltypename='DtmOnlineProtector']";
        }
    }
}