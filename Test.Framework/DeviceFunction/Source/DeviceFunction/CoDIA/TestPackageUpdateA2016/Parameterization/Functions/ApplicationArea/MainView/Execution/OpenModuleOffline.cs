...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Parameterization.Functions.ApplicationArea.MainView.Execution
{
    ...
    /// </summary>
    public class OpenModuleOffline : MarshalByRefObject, IOpenModuleOffline
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            string internModuleName = HostApplicationLoader.FDT.FieldCare.Functions.MenuArea.Menubar.Execution.OpenOfflineParameterization
                                                           .ViaMenu();
