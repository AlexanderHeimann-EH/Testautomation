// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleOpeningAndClosing.cs" company="PC-PS">
//  Endress+Hauser 
// </copyright>
// <summary>
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.Historom.Functions.ApplicationArea.MainView.Validation
{
    ...
    public class ModuleOpeningAndClosing : IModuleOpeningAndClosing
    {
        ...
        public bool WaitUntilModuleIsClosed(int timeOutInMilliseconds)
        {
            ...
            {
                Log.Info(
                    LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Module is closed after " + watch.ElapsedMilliseconds + " milliseconds. (Timeout: " + timeOutInMilliseconds + " milliseconds)");
            }
            else
            {
                Log.Error(
