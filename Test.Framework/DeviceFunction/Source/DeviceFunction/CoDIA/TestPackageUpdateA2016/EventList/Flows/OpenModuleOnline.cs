...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.EventList.Flows
{
    ...
    using EH.PCPS.TestAutomation.TestPackageUpdateA2016.EventList.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.EventList.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
