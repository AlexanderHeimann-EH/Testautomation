//------------------------------------------------------------------------------
// <copyright file="OpenLoadIdealEchoCurve.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class OpenLoadIdealEchoCurve : IOpenLoadIdealEchoCurve
    {
        /// <summary>
        ///     Start via related menu-entry
        /// </summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryLoadIdealEchoCurve;
