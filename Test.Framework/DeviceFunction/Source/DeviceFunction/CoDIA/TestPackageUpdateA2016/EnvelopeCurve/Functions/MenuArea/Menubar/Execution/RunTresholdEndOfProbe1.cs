//------------------------------------------------------------------------------
// <copyright file="RunTresholdEndOfProbe1.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageUpdateA2016.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunTresholdEndOfProbe1 : IRunTresholdEndOfProbe1
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryThresholdEndOfProbe;
