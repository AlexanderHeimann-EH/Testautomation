...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.DipTable.GUI.ApplicationArea.MainView
{
    ...
    public class ModuleContainerElements
    {
        ...
        /// </summary>
        private readonly Linearization.GUI.ApplicationArea.MainView.MainViewElementsRepository repository;
        ...
        public ModuleContainerElements()
        {
            ...
            this.repository = Linearization.GUI.ApplicationArea.MainView.MainViewElementsRepository.Instance;
        }
        ...
        public Element ModuleContainer
        {
            ...
            {
                Element element;
                RepoItemInfo itemInfo = this.repository.LinearizationModuleContainerInfo;
