            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        // Check whether the Dip table user message contains an error or does not show that reading was successful
                        if (DeviceFunctionLoader.CoDIA.DipTable.Functions.StatusArea.Usermessages.Validation.CheckUserNotificationMessages.ContainsError() || DeviceFunctionLoader.CoDIA.DipTable.Functions.StatusArea.Usermessages.Validation.CheckUserNotificationMessages.ContainsString("has been read successfully") == false)
                        {
                            result = false;
