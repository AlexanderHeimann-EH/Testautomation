...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.DipTable.Functions.StatusArea.Usermessages.Validation
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.DipTable.GUI.StatusArea.UserMessages;
