...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.ConcentrationV2.Functions.ApplicationArea.MainView.Execution
{
    ...
    public class CoefficientsOverview : ICoefficientsOverview
    {
        ...
        public string CalculatedD1
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD1);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD1, value);
            }
        }
        ...
        public string CalculatedD2
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD2);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD2, value);
            }
        }
        ...
        public string CalculatedD3
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD3);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD3, value);
            }
        }
        ...
        public string CalculatedD4
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD4);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextCalculatedD4, value);
            }
        }
        ...
        /// </summary>
        public string FromDeviceD1
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD1);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD1, value);
            }
        }
        ...
        /// </summary>
        public string FromDeviceD2
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD2);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD2, value);
            }
        }
        ...
        /// </summary>
        public string FromDeviceD3
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD3);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD3, value);
            }
        }
        ...
        /// </summary>
        public string FromDeviceD4
        {
            get
            {
                return (new CommonMethods()).GetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD4);
            }

            set
            {
                (new CommonMethods()).SetParameterValue((new CoefficientsOverviewElements()).TextFromDeviceD4, value);
            }
        }
        ...
        public bool AreCalculatedCoefficientsAvailable()
        {
            ...
            var calculatedCoeffs = new[] { this.CalculatedA0, this.CalculatedA1, this.CalculatedA2, this.CalculatedA3, this.CalculatedA4, this.CalculatedB1, this.CalculatedB2, this.CalculatedB3, this.CalculatedD1, this.CalculatedD2, this.CalculatedD3, this.CalculatedD4 };
            bool result = false;
        ...
        public bool AreReadCoefficientsAvailable()
        {
            ...
            var deviceCoeffs = new[] { this.FromDeviceA0, this.FromDeviceA1, this.FromDeviceA2, this.FromDeviceA3, this.FromDeviceA4, this.FromDeviceB1, this.FromDeviceB2, this.FromDeviceB3, this.FromDeviceD1, this.FromDeviceD2, this.FromDeviceD3, this.FromDeviceD4 };
            bool result = false;
        ...
        public bool CompareCoefficients(double accuracy, string[] expectedCoefficients)
        {
            ...
            foreach (string actualValue in calculatedCoeffs)
            {
                ...
                if (decimal.TryParse(actualValue, out actualValueAsDecimal) && decimal.TryParse(expectedCoefficients[index], out expectedCoefficientsAsDecimal))
                {
                    ...
                    {
                        Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), string.Format("Coefficients are different: calculated = {0} -> expected = {1}", calculated, userGivenCoefficient));
                        areValid &= false;
                    }
                    else
                    {
                        Log.Debug(LogInfo.Namespace(MethodBase.GetCurrentMethod()), string.Format("Coefficients are valid: calculated = {0} -> expected = {1}", calculated, userGivenCoefficient));
                        areValid &= true;
                    }
            ...
            if (areValid)
            {
                Log.Info(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Calculated coefficients and user given coefficients are equal");    
            }
            else
            {
                Log.Error(LogInfo.Namespace(MethodBase.GetCurrentMethod()), "Calculated coefficient and user given coefficients did not match.");    
            }
        ...
        {
            // create string arrays with all coefficients, calculated and read from device
            var coefficientsReadFromDevice = new[] { this.FromDeviceA0, this.FromDeviceA1, this.FromDeviceA2, this.FromDeviceA3, this.FromDeviceA4, this.FromDeviceB1, this.FromDeviceB2, this.FromDeviceB3, this.FromDeviceD1, this.FromDeviceD2, this.FromDeviceD3, this.FromDeviceD4 };
            int index = 0;
