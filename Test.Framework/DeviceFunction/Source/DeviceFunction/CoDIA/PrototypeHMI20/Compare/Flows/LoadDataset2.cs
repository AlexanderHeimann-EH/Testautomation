// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LoadDataset2.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Compare.Flows
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.Compare.Functions.ApplicationArea.MainView.Execution;

    /// <summary>
    ///     Description of LoadFile.
    /// </summary>
    public class LoadDataset2 : ILoadDataset2
    {
