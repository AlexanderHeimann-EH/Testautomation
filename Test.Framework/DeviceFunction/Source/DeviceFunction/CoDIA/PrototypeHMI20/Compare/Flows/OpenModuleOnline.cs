...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Compare.Flows
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.Compare.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.Compare.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
