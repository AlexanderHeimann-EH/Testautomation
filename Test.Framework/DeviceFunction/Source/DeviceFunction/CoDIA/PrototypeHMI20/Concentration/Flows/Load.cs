...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Concentration.Flows
{
    ...
    using Validation = EH.PCPS.TestAutomation.DeviceFunctionLoader.CoDIA.Concentration.Functions.StatusArea.Statusbar.Validation;
    ...
    public class Load : ILoad
    {
        ...
        public bool Run(string fileName)
        {
            try
            {
                ...
                if (Validation.CheckUserNotificationMessages.Run("Data loaded successfully"))
                {
