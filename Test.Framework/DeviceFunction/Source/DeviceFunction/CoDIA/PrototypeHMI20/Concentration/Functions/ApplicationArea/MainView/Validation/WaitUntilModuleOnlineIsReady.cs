...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Concentration.Functions.ApplicationArea.MainView.Validation
{
    using System;
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.Concentration.GUI.ApplicationArea.MainView;
