...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurveShed.Functions.Dialogs.ZoomAndGridSettings.Execution
{
    using System;
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurveShed.GUI.Dialogs;
