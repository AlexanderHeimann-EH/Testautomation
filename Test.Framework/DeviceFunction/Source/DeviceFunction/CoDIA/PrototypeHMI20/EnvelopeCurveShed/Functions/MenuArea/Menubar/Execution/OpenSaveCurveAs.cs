// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenSaveCurveAs.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurveShed.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class OpenSaveCurveAs : IOpenSaveCurveAs
    {
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntrySaveCurveAs;
