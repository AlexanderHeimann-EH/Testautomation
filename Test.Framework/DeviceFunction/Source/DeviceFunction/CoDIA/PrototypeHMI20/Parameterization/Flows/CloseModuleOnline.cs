// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CloseModuleOnline.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Parameterization.Flows
{
    ...
    ///     Provides function to close module frame-independent
    /// </summary>
    public class CloseModuleOnline : ICloseModuleOnline
    {
        ...
        public bool Run(int timeoutInMilliseconds)
        {
            ...
            bool result = new Functions.ApplicationArea.MainView.Execution.CloseModuleOnline().ViaWindow();
