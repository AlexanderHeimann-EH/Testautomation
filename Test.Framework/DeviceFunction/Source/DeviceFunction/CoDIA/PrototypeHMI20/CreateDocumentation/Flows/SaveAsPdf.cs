...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.CreateDocumentation.Flows
{
    using System;
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.CreateDocumentation.Functions.ApplicationArea.MainView.Execution;
        ...
        public bool Run(string fileName, bool waitUntilFinished, int timeOutInMilliseconds)
        {
            try
            {
                ...
                if ((new OpenSaveAs()).ViaButton())
                {
                    ...
                    {
                        // if should be waited for printing is finished
