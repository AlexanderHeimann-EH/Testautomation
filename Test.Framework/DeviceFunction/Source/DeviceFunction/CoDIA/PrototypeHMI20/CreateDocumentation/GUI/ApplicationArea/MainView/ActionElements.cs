    ...
    public class ActionElements
    {
        ...
        public Button Print
        {
            get
            {
                ...
                {
                    Button button;
                    RepoItemInfo buttonPrintInfo = this.repository.ActionElements.buttonPrintInfo;
        ...
        public Button Cancel
        {
            get
            {
                ...
                {
                    Button button;
                    RepoItemInfo buttonCancelInfo = this.repository.ActionElements.buttonCancelInfo;
                    Host.Local.TryFindSingle(
        ...
        public Button SaveAs
        {
            get
            {
                ...
                {
                    Button button;
                    RepoItemInfo buttonSaveAsInfo = this.repository.ActionElements.buttonSaveAsInfo;
                    Host.Local.TryFindSingle(
