...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.CreateDocumentation.Functions.ApplicationArea.MainView.Validation
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.CreateDocumentation.GUI.ApplicationArea.MainView;
