...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurve.Functions.Dialogs.ZoomAndGridSettings.Execution
{
    using System;
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurve.GUI.Dialogs;
