//------------------------------------------------------------------------------
// <copyright file="RunDiagramPlausibility.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunDiagramPlausibility : IRunDiagramPlausibility
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryDiagramPlausibility;
