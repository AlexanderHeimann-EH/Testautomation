...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Viscosity.Flows
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.Viscosity.Functions.ApplicationArea.MainView.Validation;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (DeviceFunctionLoader.CoDIA.Viscosity.Functions.StatusArea.Statusbar.Validation.WaitUntilDtmIsConnected.Run(DefaultValues.iTimeoutModules) == false)
                        {
