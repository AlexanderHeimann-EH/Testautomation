...
namespace EH.PCPS.TestAutomation.PrototypeHMI20.Linearization.Functions.StatusArea.Usermessages.Validation
{
    ...
    using EH.PCPS.TestAutomation.PrototypeHMI20.Linearization.GUI.StatusArea.UserMessages;
