// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunOverlappedCurves.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageCI.EnvelopeCurveShed.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunOverlappedCurves : IRunOverlappedCurves
    {
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryOverlappedCurves;
