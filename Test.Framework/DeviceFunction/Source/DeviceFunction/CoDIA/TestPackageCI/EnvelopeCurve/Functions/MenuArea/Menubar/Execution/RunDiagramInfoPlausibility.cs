//------------------------------------------------------------------------------
// <copyright file="RunDiagramInfoPlausibility.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageCI.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunDiagramInfoPlausibility : IRunDiagramInfoPlausibility
    {
        /// <summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryDiagramInfoPlausibility;
