//------------------------------------------------------------------------------
// <copyright file="RunEditMAP.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.TestPackageCI.EnvelopeCurve.Functions.MenuArea.Menubar.Execution
{
    ...
    /// </summary>
    public class RunEditMAP : MarshalByRefObject, IRunEditMAP
    {
        /// <summary>
        ///     Start via related menu-entry
        /// </summary>
        ...
        public bool ViaMenu()
        {
            try
            {
                ...
                {
                    Button button = (new Elements()).EntryEditMAP;
