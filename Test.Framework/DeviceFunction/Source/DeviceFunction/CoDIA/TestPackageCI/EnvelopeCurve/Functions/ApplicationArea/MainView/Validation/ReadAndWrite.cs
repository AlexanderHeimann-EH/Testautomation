...
namespace EH.PCPS.TestAutomation.TestPackageCI.EnvelopeCurve.Functions.ApplicationArea.MainView.Validation
{
    ...
    public class ReadAndWrite : IReadAndWrite
    {
        ...
        public bool WaitUntilReadFinished(int timeOutInMilliseconds)
        {
            ...
            while (this.IsReading())
            {
                ...
                EH.PCPS.TestAutomation.Common.Tools.Log.Error(
                    ...
                    "Single curve reading did not finish within " + timeOutInMilliseconds + " milliseconds");
                watch.Stop();
                return false;
            }
            ...
            EH.PCPS.TestAutomation.Common.Tools.Log.Info(
                LogInfo.Namespace(MethodBase.GetCurrentMethod()),
                "Curve reading finished after " + watch.ElapsedMilliseconds + " milliseconds. (Timeout: " + timeOutInMilliseconds + " milliseconds)");
            return true;
        }
        ...
        {
            Button progress = (new GUI.StatusArea.Statusbar.StatusbarElements()).OperationInProgress;
