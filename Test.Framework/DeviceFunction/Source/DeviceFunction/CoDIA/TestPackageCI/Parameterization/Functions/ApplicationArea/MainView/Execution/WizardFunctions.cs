...
namespace EH.PCPS.TestAutomation.TestPackageCI.Parameterization.Functions.ApplicationArea.MainView.Execution
{
    ...
    public class WizardFunctions : IWizardFunctions
    {
        ...
        /// <summary>
        /// The get wizard parameter enums.
        /// </summary>
        /// <param name="parameterName">
        /// The parameter name.
        /// </param>
        ...
        /// The <see cref="List"/>.
        /// </returns>
        public List<string> GetWizardParameterEnums(string parameterName)
        {
            string result = string.Empty;
            Application applicationArea = new Application();
            Unknown parameterControl = applicationArea.SearchAndSelectParameter(parameterName);
            if (parameterControl != null && parameterControl.Visible)
            {
                return applicationArea.GetParameterEnums(parameterControl);
            }
