...
namespace EH.PCPS.TestAutomation.TestPackageCI.Parameterization.Functions.ApplicationArea.MainView.Execution
{
    ...
    public class Navigation : INavigation
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether is button scroll bar down initialized.
        /// </summary>
        public bool IsButtonScrollBarDownInitialized { get; set; }
        ...
        public void ScrollDownTreeUntilTreeItemIsVisibleOrScrollbarBottomReached(TreeItem nextTreeItem)
        {
            ...
            if (this.elementScrollBar.Visible)
            {
                ...
                {
                    // 2017-07-18 - EC: Added during bugfix.
                    // In case no next tree item exists
                    if (nextTreeItem.Element.Location.Y < 0 && nextTreeItem.Element.Location.X < 0)
                    {
                        while (this.buttonPageDown.ScreenRectangle.Height > 0 && nextTreeItem.ScreenRectangle.Y == 0 && nextTreeItem.ScreenRectangle.X == 0)
                        {
                            // Scroll page down 
                    ...
                    else 
                    {
                        while ((this.buttonLineDown != null && 
                            ...
                            this.buttonPageDown.ScreenRectangle.Height > 0) || 
                            nextTreeItem.Visible == false)
                        {
                            // Scroll page down
                            Mouse.Click(this.buttonPageDown);
                        }
                    ...
                    // 2017-07-18 - EC: Removed during bugfix.
