...
namespace EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.Flows
{
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.Functions.ApplicationArea.MainView.Validation;
    using EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.GUI.ApplicationArea.MainView;

    using Navigation = EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.Functions.ApplicationArea.MainView.Execution.Navigation;
    using Selection = EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.Functions.ApplicationArea.MainView.Execution.Selection;
