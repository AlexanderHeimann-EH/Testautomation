...
namespace EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.Functions.StatusArea.Statusbar.Validation
{
    using System;
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.SaveRestore.GUI.StatusArea.Statusbar;
