...
namespace EH.PCPS.TestAutomation.TestPackageCI.EventList.Functions.StatusArea.Statusbar.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.EventList.GUI.StatusArea.Statusbar;
