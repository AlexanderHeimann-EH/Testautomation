...
namespace EH.PCPS.TestAutomation.TestPackageCI.AboutBox.Functions.ApplicationArea.MainView.Validation
{
    ...
    /// </summary>
    public class WaitUntilModuleIsReady : IWaitUntilModuleIsReady
    {
        /// <summary>
        ...
        public bool Run(int timeOutInMilliseconds)
        {
            ...
            else
            {
                Log.Error(
                    ...
                    "Module is not ready after " + timeOutInMilliseconds + "Milliseconds. The button [Copy To Clipboard] is not available");
            }
