...
namespace EH.PCPS.TestAutomation.TestPackageCI.Compare.Functions.StatusArea.Statusbar.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.Compare.GUI.Resources;
