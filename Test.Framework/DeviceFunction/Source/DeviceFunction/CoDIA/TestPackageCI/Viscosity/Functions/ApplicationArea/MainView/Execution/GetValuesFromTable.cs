...
namespace EH.PCPS.TestAutomation.TestPackageCI.Viscosity.Functions.ApplicationArea.MainView.Execution
{
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.Viscosity.GUI.ApplicationArea.MainView;
    ...
    public class GetValuesFromTable : IGetValuesFromTable
    {
        ...
        public List<string> AllValues()
        {
            ...
            {
                if (cell.GetAttributeValueText("AccessibleName").Contains(";0") || cell.GetAttributeValueText("AccessibleName").Contains(";1"))
                {
        ...
        public void PrintAllValuesInReport()
        {
            ...
            {
                output.AppendLine("Row " + rowIndex + ": " + list[i] + ";" + list[i + 1]);
                i = i + 1;
                rowIndex++;
            }
