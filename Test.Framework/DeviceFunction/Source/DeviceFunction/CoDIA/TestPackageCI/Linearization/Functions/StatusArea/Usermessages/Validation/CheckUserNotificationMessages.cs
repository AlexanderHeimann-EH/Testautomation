...
namespace EH.PCPS.TestAutomation.TestPackageCI.Linearization.Functions.StatusArea.Usermessages.Validation
{
    ...
    using EH.PCPS.TestAutomation.TestPackageCI.Linearization.GUI.StatusArea.UserMessages;
