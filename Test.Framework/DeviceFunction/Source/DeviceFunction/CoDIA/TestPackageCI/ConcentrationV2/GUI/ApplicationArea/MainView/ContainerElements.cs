...
namespace EH.PCPS.TestAutomation.TestPackageCI.ConcentrationV2.GUI.ApplicationArea.MainView
{
    ...
    public class ContainerElements
    {
        ...
        /// <summary>
        /// Gets the tab reference values.
        /// </summary>
        /// <value>The tab reference values.</value>
        public Element TabReferenceValues
        {
            get
            {
                try
                {
                    Element element;
                    RepoItemInfo infoTabulatorBaseSettings = this.concentration.Tabulator.ReferenceValuesInfo;
                    Host.Local.TryFindSingle(this.mdiClientPath + infoTabulatorBaseSettings.AbsolutePath, DefaultValues.iTimeoutLong, out element);
                    return element;
                }
                catch (Exception exception)
        ...
        /// <summary>
        /// Gets the tab page Reference values.
        /// </summary>
        public Element TabPageReferenceValues
        {
            get
            {
                Element element;
                RepoItemInfo elementInfo = this.concentration.Tabulator.TabPageReferenceValuesInfo;
                Host.Local.TryFindSingle(this.mdiClientPath + elementInfo.AbsolutePath, DefaultValues.iTimeoutLong, out element);
                return element;
            }
        }
