// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EditorFactory.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.DTMstudioTest.Template
{
    ...
    /// Factory for creating our editor object. Extends from the IVsEditoryFactory interface
    /// </summary>
    [Guid(GuidList.guidDTMstudioTestEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        ...
        /// The editor package.
        /// </summary>
        private readonly DTMstudioTestPackage editorPackage;

        /// <summary>
        /// The vs service provider.
        /// </summary>
        ...
        /// The package.
        /// </param>
        public EditorFactory(DTMstudioTestPackage package)
        {
        ...
        /// </param>
        /// <param name="itemid">
        /// Item identifier of this editor instance
        /// </param>
