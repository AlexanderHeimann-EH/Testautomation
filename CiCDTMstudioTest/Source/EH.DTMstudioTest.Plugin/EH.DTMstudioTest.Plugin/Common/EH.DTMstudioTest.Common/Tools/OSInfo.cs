// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OSInfo.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.DTMstudioTest.Common.Tools 
{
    ...
    public static class OSInfo
    {
        ...
        public static string Edition
        {
            get
            {
                if (s_Edition != null) return s_Edition; //***** RETURN *****//
        ...
        public static string Name
        {
            get
            {
                if (s_Name != null) return s_Name; //***** RETURN *****//
                                ...
                                if (majorVersion == 4)
                                {
                                    ...
                                    switch (minorVersion)
                                    {
                                        case 0:
                                            ...
                                            break;
                                        case 10:
                                            if (csdVersion == "A") name = "Windows 98 Second Edition";
                                            else name = "Windows 98";
                                            break;
                                        case 90:
                                            name = "Windows Me";
                                            break;
        ...
        internal static extern bool GetProductInfo(
            int osMajorVersion, int osMinorVersion, int spMajorVersion, int spMinorVersion, out int edition);
