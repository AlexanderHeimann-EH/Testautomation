...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.DTMstudioTest.Common.Utilities.Logging.Log4Net
{
    #region
    ...
    using EH.DTMstudioTest.Common.Utilities.Logging.Log4Net.SpecialLogs;
    ...
    public class Log4NetLog
    {
        ...
        /// </summary>
        private const string LoggerConfigurationFile = "cicdtmstudiotest.logger.conf.xml";
