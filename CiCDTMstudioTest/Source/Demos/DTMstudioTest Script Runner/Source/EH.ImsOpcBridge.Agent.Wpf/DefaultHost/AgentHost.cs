// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AgentHost.cs" company="Endress+Hauser Process Solutions AG">
...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.ImsOpcBridge.Agent.Wpf.DefaultHost
{
    using System;
    ...
    /// </summary>
    [CLSCompliant(false)]
    public class AgentHost : IConfiguratorHost, ICommServerCallback
    {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="AgentHost"/> class.
        /// </summary>
        ~AgentHost()
        {
