// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BridgeSettingItemVm.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.ImsOpcBridge.Configurator.ViewModel
{
    ...
    /// <summary>
    /// Class BridgeSettingItemVm
    /// </summary>
    public class BridgeSettingItemVm : PageViewModel
    {
        ...
        /// </summary>
        public static readonly DependencyProperty AutomationIdProperty = DependencyProperty.Register("AutomationId", typeof(string), typeof(BridgeSettingItemVm), new PropertyMetadata(default(string)));

        /// <summary>
        /// The expand button image path property
        /// </summary>
        public static readonly DependencyProperty ExpandButtonImagePathProperty = DependencyProperty.Register("ExpandButtonImagePath", typeof(string), typeof(BridgeSettingItemVm), new PropertyMetadata(default(string)));

        /// <summary>
        /// The expand button visibility property
        /// </summary>
        public static readonly DependencyProperty ExpandButtonVisibilityProperty = DependencyProperty.Register("ExpandButtonVisibility", typeof(Visibility), typeof(BridgeSettingItemVm), new PropertyMetadata(default(Visibility)));

        /// <summary>
        /// The is expanded property
        /// </summary>
        public static readonly DependencyProperty IsExpandedProperty = DependencyProperty.Register("IsExpanded", typeof(bool), typeof(BridgeSettingItemVm), new PropertyMetadata(default(bool)));

        /// <summary>
        /// The own configuration property
        /// </summary>
        public static readonly DependencyProperty OwnConfigurationProperty = DependencyProperty.Register("OwnConfiguration", typeof(OwnConfigurationControlVm), typeof(BridgeSettingItemVm), new PropertyMetadata(default(OwnConfigurationControlVm)));

        /// <summary>
        /// The title property
        /// </summary>
        public static readonly DependencyProperty ItemTitleProperty = DependencyProperty.Register("ItemTitle", typeof(string), typeof(BridgeSettingItemVm), new PropertyMetadata(default(string)));

        /// <summary>
        /// The visibility property
        /// </summary>
        public static readonly DependencyProperty VisibilityProperty = DependencyProperty.Register("Visibility", typeof(Visibility), typeof(BridgeSettingItemVm), new PropertyMetadata(default(Visibility)));
        ...
        /// </summary>
        private readonly BridgeSettingCtrlVm bridgeSettingCtrlVm;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BridgeSettingItemVm"/> class.
        /// </summary>
        /// <param name="bridgeSettingCtrlVm">The documentation view model.</param>
        /// <param name="view">The view.</param>
        /// <param name="viewModel">The view model.</param>
        /// <param name="title">The title.</param>
        /// <param name="isExpandable">if set to <c>true</c> [is expandable].</param>
        /// <param name="automationId">The automation id.</param>
        public BridgeSettingItemVm(BridgeSettingCtrlVm bridgeSettingCtrlVm, UserControl view, PageViewModel viewModel, string title, bool isExpandable, [Localizable(false)] string automationId)
        {
            this.bridgeSettingCtrlVm = bridgeSettingCtrlVm;
        ...
        public BridgeSettingCtrlVm BridgeSettingCtrlVm
        {
            get
            {
                return this.bridgeSettingCtrlVm;
            }
        }
        ...
        protected void Expand()
        {
            if (!this.IsExpanded)
            {
                this.BridgeSettingCtrlVm.SelectBridgeSettingItem(this);
            }
            else
            {
                this.IsExpanded = false;
