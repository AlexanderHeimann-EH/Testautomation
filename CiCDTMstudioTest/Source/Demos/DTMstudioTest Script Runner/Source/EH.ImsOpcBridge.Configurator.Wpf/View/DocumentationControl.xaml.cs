// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DocumentationControl.xaml.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.ImsOpcBridge.Configurator.View
{
    ...
    public partial class DocumentationControl : UserControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentationControl" /> class.
        /// </summary>
