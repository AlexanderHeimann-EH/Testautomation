// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BridgeSettingCtrl.xaml.cs" company="Endress+Hauser Process Solutions AG">
//   Copyright (c) Endress+Hauser Process Solutions AG. All rights reserved.
// </copyright>
// <summary>
//   Interaction logic for BridgeSettingCtrl.xaml
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace EH.ImsOpcBridge.Configurator.View
{
    ...
    /// <summary>
    /// Class BridgeSettingCtrl
    /// </summary>
    public partial class BridgeSettingCtrl : UserControl
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="BridgeSettingCtrl"/> class.
        /// </summary>
        public BridgeSettingCtrl()
        {
        ...
        private void ScrollToCurrentItem()
        {
            ...
            foreach (var item in this.ItemsControl.Items)
            {
                ...
                var itemViewModel = item as BridgeSettingItemVm;
