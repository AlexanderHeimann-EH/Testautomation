	...
	public class TreeList : ListView
	{
		...
		internal void CreateChildrenNodes(TreeNode node)
		{
			...
			if (children != null)
			{
                ...
                node.ChildrenSource = this.GetChildrenCollection(node) as INotifyCollectionChanged; 
        ...
        private IEnumerable GetChildrenCollection(TreeNode parent)
        {
            if (Model != null)
                return Model.GetChildrenCollection(parent.Tag);
            else
                return null;
        }
