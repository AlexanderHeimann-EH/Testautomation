...
namespace EndressHauserProcessSolutionsAG.EH_DTMstudioTest_Solution
{
    ...
    /// </summary>
    [Guid(GuidList.guidEH_DTMstudioTest_SolutionEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private EH_DTMstudioTest_SolutionPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(EH_DTMstudioTest_SolutionPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidEH_DTMstudioTest_SolutionEditorFactory;
            pgrfCDW = 0;
