...
namespace EndressHauserProcessSolutionsAG.EH_DTMstudioTest_Solution
{
    ...
    //     - An empty ehdtmstudiotestsolution file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.ehdtmstudiotestsolution. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.ehdtmstudiotestsolution, MyExtFile2.ehdtmstudiotestsolution... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.ehdtmstudiotestsolution|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.ehdtmstudiotestsolution - our empty ehdtmstudiotestsolution file
    ...
    //    - #107 - the ID of "ehdtmstudiotestsolution"
    ///////////////////////////////////////////////////////////////////////////////
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".ehdtmstudiotestsolution";
        ...
        #region Fields
        private EH_DTMstudioTest_SolutionPackage myPackage;
        ...
        public EditorPane(EH_DTMstudioTest_SolutionPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the ehdtmstudiotestsolution document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(EH_DTMstudioTest_SolutionPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidEH_DTMstudioTest_SolutionCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidEH_DTMstudioTest_SolutionCmdSet, PkgCmdIDList.IDMX_RTF);
