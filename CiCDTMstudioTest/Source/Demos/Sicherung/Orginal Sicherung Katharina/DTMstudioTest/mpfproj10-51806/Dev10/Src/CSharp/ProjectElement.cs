...
namespace Microsoft.VisualStudio.Project
{
    ...
    public sealed class ProjectElement
    {
        ...
        /// <summary>
        /// Get the unevaluated value of an attribute on a project element
        /// </summary>
        /// <param name="attributeName">Name of the attribute to get the value for</param>
        /// <returns>Value of the attribute</returns>
        public string GetUnevaluatedMetadata(string attributeName)
        {
            ...
            foreach (ProjectMetadata metadata in item.Metadata)
            {
                ...
                {
                    retval = metadata.UnevaluatedValue;
                    break;
                }
            }
