...
using EndressHauser.DTMstudioTest;

namespace DTMstudioTest_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new DTMstudioTestPackage() as IVsPackage;
            ...
            BaseMock registerEditor = DTMstudioTest_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID(EndressHauser.DTMstudioTest.GuidList.guidDTMstudioTestCmdSet, (int)EndressHauser.DTMstudioTest.PkgCmdIDList.cmdidMyCommand);
