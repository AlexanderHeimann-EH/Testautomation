...
namespace DTMstudioTest_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(EndressHauser.DTMstudioTest.GuidList.guidDTMstudioTestCmdSet, (int)EndressHauser.DTMstudioTest.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "DTMstudioTest", "EndressHauser.DTMstudioTest.DTMstudioTestPackage");
