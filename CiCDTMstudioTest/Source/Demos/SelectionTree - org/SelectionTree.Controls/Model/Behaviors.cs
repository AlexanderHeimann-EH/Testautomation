...
namespace SelectionTree.Controls.Tree
{
    ...
    public static class GridViewColumnResize
    {
        ...
        public static readonly DependencyProperty GridViewColumnResizeBehaviorProperty = DependencyProperty.RegisterAttached("GridViewColumnResizeBehavior",
        ...
        public static readonly DependencyProperty ListViewResizeBehaviorProperty = DependencyProperty.RegisterAttached("ListViewResizeBehaviorProperty",
        ...
        public class ListViewResizeBehavior
        {
            ...
            private void Resize()
            {
                if (Enabled)
                {
                    ...
                    if (gv != null)
                    {
                        ...
                        {
                            behavior.SetWidth(Math.Max(allowedSpace, 0), totalPercentage);
                        }
                    }
                }
            }
            ...
            private double GetAllocatedSpace(GridView gv)
            {
                ...
                {
                    Decorator border = VisualTreeHelper.GetChild(_element, 0) as Decorator;
                    if (border != null)
                    {
                        ...
                        if (scroller != null)
                        {
                            ...
                            if (presenter != null)
                            {
                                totalWidth = Math.Max(_element.ActualWidth - presenter.ActualWidth, 0);
                            }
                        }
                    }
                }
                ...
                //var gv = _element.View as GridView;
                //ScrollBar scrollBar = (sender as ScrollViewer).Template.FindName("PART_HorizontalScrollBar", sender as ScrollViewer) as ScrollBar;
                //_scrollViewer = VisualTreeHelper.GetChild(gv, 0) as ScrollViewer;
