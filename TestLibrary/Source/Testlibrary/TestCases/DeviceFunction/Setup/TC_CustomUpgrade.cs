//------------------------------------------------------------------------------
// <copyright file="TC_CustomUpgrade.cs" company="Endress+Hauser Process Solutions AG">
...
{
    /// <summary>
    ///     Description of TC_CustomUpgrade.
    /// </summary>
    public class TC_CustomUpgrade
    {
        /// <summary>
        ///     Start testcase
        /// </summary>
        ...
        /// <param name="ignoreWarnings">Setting to ignore warnings or not</param>
        /// <returns>
                                       ...
                                       bool ignoreWarnings)
        {
            ...
            isPassed &= WizzardNavigation.Next(ignoreWarnings);
            isPassed &= WizzardNavigation.Next(ignoreWarnings);
            isPassed &= WizzardSelection.CustomUpgrade();
