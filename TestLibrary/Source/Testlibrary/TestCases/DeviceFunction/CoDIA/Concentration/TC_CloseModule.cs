...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.Concentration
{
    ...
    public class TC_CloseModule
    {
        ...
        /// </returns>
        [TestScriptInformation("0954F222-D998-4286-B5D7-5D6BB76228C1", TestDefinition.Predefined, TestScript.TestCase)]
        ...
        /// Returns true if test case is passed, false otherwise.
        /// </returns>
        [TestScriptInformation("51FC3570-65EB-4F1C-AE34-25405C777687", TestDefinition.Predefined, TestScript.TestCase)]
