// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TC_CancelSilSequence.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.Parameterization
{
    ...
    public class TC_CancelSilSequence
    {
        ...
        /// </returns>
        [TestScriptInformation("18cffbeb-8f6a-410b-aa97-fe3a1dc93449", TestDefinition.Predefined, TestScript.TestCase)]
