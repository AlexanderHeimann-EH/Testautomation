...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.Linearization
{
    ...
    public class TC_OpenModuleOnline
    {
        ...
        /// </returns>
        [TestScriptInformation("07ba1ab6-81f6-494f-98a5-836b618fecc5", TestDefinition.Predefined, TestScript.TestCase)]
        ...
        /// Returns true if test case is passed, false otherwise.
        /// </returns>
        [TestScriptInformation("E0682DDE-F00E-42EB-B15E-53858A570F33", TestDefinition.Predefined, TestScript.TestCase)]
