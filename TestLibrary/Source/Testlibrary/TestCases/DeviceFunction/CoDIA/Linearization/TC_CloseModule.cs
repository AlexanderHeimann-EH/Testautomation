...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.Linearization
{
    ...
    public class TC_CloseModule
    {
        ...
        /// </returns>
        [TestScriptInformation("59c636c1-3c4f-4bd4-8538-984e50fa78cc", TestDefinition.Predefined, TestScript.TestCase)]
        ...
        /// Returns true if test case is passed, false otherwise.
        /// </returns>
        [TestScriptInformation("59986162-F76A-4618-B2EF-2AAA8032C47A", TestDefinition.Predefined, TestScript.TestCase)]
