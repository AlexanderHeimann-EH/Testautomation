...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.ConcentrationV2
{
    ...
    public class TC_OpenModuleOnline
    {
        ...
        /// </returns>
        [TestScriptInformation("B819EBB4-3358-4015-B816-CAAAFA32D43E", TestDefinition.Predefined, TestScript.TestCase)]
        ...
        /// Returns true if test case is passed, false otherwise.
        /// </returns>
        [TestScriptInformation("80A95B96-4591-4BE5-98DC-6A3858B0C0DC", TestDefinition.Predefined, TestScript.TestCase)]
