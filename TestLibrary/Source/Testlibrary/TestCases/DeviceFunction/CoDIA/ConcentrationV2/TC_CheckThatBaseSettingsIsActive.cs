// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TC_CheckThatBaseSettingsIsActive.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.ConcentrationV2
{
    ...
    public class TC_CheckThatBaseSettingsIsActive
    {
        ...
        [TestScriptInformation("BD0FAE72-1759-4C78-98DA-F3D53269E3CF", TestDefinition.Predefined, TestScript.TestCase)]
