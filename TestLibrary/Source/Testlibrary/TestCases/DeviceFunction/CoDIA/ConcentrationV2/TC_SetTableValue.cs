...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.ConcentrationV2
{
    ...
    public class TC_SetTableValue
    {
        ...
        /// </returns>
        [TestScriptInformation("41914FFE-7D72-44D7-83A0-114D2F49549E", TestDefinition.Predefined, TestScript.TestCase)]
        public static bool Run(string inputValues)
        {
            ...
            isPassed &= Execution.SetTableValues.SetValues(StringToListConverter.Run(inputValues));
            if (isPassed)
            {
