...
namespace EH.PCPS.TestAutomation.Testlibrary.TestCases.DeviceFunction.CoDIA.SaveRestore
{
    ...
    public class TC_OpenModuleOnline
    {
        ...
        /// </returns>
        [TestScriptInformation("01c008e8-3579-4be4-8d24-bb239aa19ab9", TestDefinition.Predefined, TestScript.TestCase)]
        ...
        /// Returns true if test case is passed, false otherwise.
        /// </returns>
        [TestScriptInformation("883A1FAA-410B-4932-BBF1-B70706103ADE", TestDefinition.Predefined, TestScript.TestCase)]
