// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TM_DisconnectCurrentDeviceViaIcon.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.Testlibrary.TestModules.HostApplication.FDT.FieldCare
{
    ...
    /// </summary>
    public class TM_DisconnectCurrentDeviceViaIcon
    {
        /// <summary>
        /// Execute test module
        /// </summary>
        ...
        {
            bool isPassed = true;
            isPassed &= Execution.RunDisconnect.ViaIcon();
            isPassed &= Validation.WaitUntilFrameDisconnected.Run(timeOutInMilliseconds);
