// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TM_ConnectCurrentDeviceViaMenu.cs" company="Endress+Hauser Process Solutions AG">
...
namespace EH.PCPS.TestAutomation.Testlibrary.TestModules.HostApplication.FDT.FieldCare
{
    ...
    /// </summary>
    public class TM_ConnectCurrentDeviceViaMenu
    {
        /// <summary>
        /// Execute test module
        /// </summary>
        ...
        {
            bool isPassed = true;
            isPassed &= Execution.RunConnect.ViaMenu();
            isPassed &=
                HostApplicationLoader.FDT.FieldCare.Functions.MenuArea.Toolbar.Validation.WaitUntilFrameConnected.Run(
